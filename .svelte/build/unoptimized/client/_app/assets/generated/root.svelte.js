...
function create_else_block(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*$$scope, components, props_2*/ 4132) {
...
// (48:3) {#if components[2]}
function create_if_block_3(ctx) {
	let switch_instance;
	let switch_instance_anchor;
	let current;
	const switch_instance_spread_levels = [/*props_2*/ ctx[5] || {}];
	var switch_value = /*components*/ ctx[2][2];
	...
	return {
		...
		p(ctx, dirty) {
			const switch_instance_changes = (dirty & /*props_2*/ 32)
			? get_spread_update(switch_instance_spread_levels, [get_spread_object(/*props_2*/ ctx[5] || {})])
			: {};

			if (switch_value !== (switch_value = /*components*/ ctx[2][2])) {
				if (switch_instance) {
					group_outros();
					const old_component = switch_instance;
...
// (47:2) <svelte:component this={components[1]} {...(props_1 || {})}>
function create_default_slot_1(ctx) {
	let if_block_anchor;
	let current;
	let if_block = /*components*/ ctx[2][2] && create_if_block_3(ctx);
...
function create_if_block_1(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t1 = claim_text(nodes, /*title*/ ctx[8]);
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*title*/ 256) set_data(t1, /*title*/ ctx[8]);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	layout = new /*Layout*/ ctx[9]({ props: layout_props });
	let if_block = /*mounted*/ ctx[6] && create_if_block(ctx);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*$$scope, status, error, components, props_1, props_2*/ 4151) {
...
function instance($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		const unsubscribe = stores.page.subscribe(() => {
			if (mounted) {
				...
				$$invalidate(8, title = document.title);
			}
		});
	...
	$$self.$$set = $$props => {
		...
		if ("props_2" in $$props) $$invalidate(5, props_2 = $$props.props_2);
	};
